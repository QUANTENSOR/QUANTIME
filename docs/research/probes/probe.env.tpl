...
#
# The item name contains spaces and the field is `token`, so the reference
# must stay quoted.
GITHUB_TOKEN="op://quant-dev/GitHub Personal Access Token/token"
...
GITHUB_TOKEN_SOURCE="op:quant-dev/GitHub Personal Access Token"
