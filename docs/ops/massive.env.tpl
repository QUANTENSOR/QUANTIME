...
#       uv run --package quantime-data --extra ingest quantime-ingest-us ingest \
#           --start 2024-01-01 --end 2024-01-31
#
# Phase 1 (this PR) needs NO key: the adapter and every test run offline against
# the hand-written synthetic fixtures in fixtures/massive/. This template exists
# so phase 2 has nothing left to invent — and so the vault path is reviewed now.
#
...
MASSIVE_API_KEY="op://quant-dev/Massive/credential"
...
MASSIVE_API_KEY_SOURCE="op:quant-dev/Massive/credential"
